...
<form action="player" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" placeholder="Father" name="father">
    </div>
    
    <div class="form-group col-md-6">
      <label >Married</label>
      <input type="text" class="form-control" placeholder="Married" name="married">
    </div>
    
    <div class="form-group col-md-6">
      <label>Jersey Number</label>
      <input type="number" class="form-control" placeholder="JerseyNo" name="jersey">
    </div>

    <div class="form-group col-md-6">
      <label>Alive</label>
      <input type="text" class="form-control" placeholder="Alive" name="alive">
    </div>
 </div>
